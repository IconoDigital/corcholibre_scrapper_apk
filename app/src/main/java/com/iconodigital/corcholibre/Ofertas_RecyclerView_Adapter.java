...
public class Ofertas_RecyclerView_Adapter extends RecyclerView.Adapter<Ofertas_RecyclerView_Adapter.MyViewHolder> {
    ...
    public Ofertas_RecyclerView_Adapter(List<Product> productList,
                                        Context context, String type) {
        this.productList = productList;

        this.context = context;
        this.type = type;
        //this.selected_product_ids_arr=selected_product_ids_arr;
    ...
    @Override
    public Ofertas_RecyclerView_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerview_cell_ofertas, parent, false);


        return new Ofertas_RecyclerView_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Ofertas_RecyclerView_Adapter.MyViewHolder holder, final int position) {
        ...
        if (item.offer_price == null || item.offer_price.equals("")) {
            ...
            if(
                ...
                if (item.offer_title.trim().equals("")) {
                ...
                holder.offerPrice.setText(applicationClass.CURRENCY_SYMBOL + item.offer_price);
...
/*
        holder.parent_ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                product_details.putExtra("Product", productList.get(position));
...
*/
        ...
        if(applicationClass.selected_product_ids_arr.contains(productList.get(position).product_id)){
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int product_id=productList.get(position).product_id;
                if(((CheckBox)view).isChecked()){
                    applicationClass.selected_product_ids_arr.add(product_id);
                    applicationClass.selected_prod_map.put(product_id,productList.get(position));
                }
                else{
                    applicationClass.selected_product_ids_arr.remove(product_id+"");
        ...
        holder.productImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                zoomImageFromThumb(holder.productImg, productList.get(position).product_id, item.img_url);
    ...
    public void update_productList_searches(List<Product> productList_searches) {
        ...
        try {
            ...
            this.productList.addAll(productList_temp);
