...
public class ListItems_RecyclerView_Adapter extends RecyclerView.Adapter<ListItems_RecyclerView_Adapter.MyViewHolder> {

    static final int CHANGE_PRODUCT_QUANTITY = 1;
    Drawable default_drawable;
    ListItemsActivity context;
    ...
    public ListItems_RecyclerView_Adapter(ArrayList<Product> productItemList, ListItemsActivity context, ImageView iv_expand, FrameLayout flPlazavia, int list_id) {
    ...
    @Override
    public ListItems_RecyclerView_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerview_cell_list_item, parent, false);
        return new ListItems_RecyclerView_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final ListItems_RecyclerView_Adapter.MyViewHolder holder, final int position) {
        ...
        holder.quantity.setText("Quantity :"+(items.getQuantity()>0?items.getQuantity():1));
        ...
        if (items.offer_price==null|| items.offer_price.equals("")){
            ...
            holder.total.setText("Total: S/. "+String.format("%.2f",items.getQuantity()* getPriceFromString(items.getPrice())));
            ...
            if(
                ...
                holder.total.setText("Total: S/. "+String.format("%.2f",items.getQuantity()* getPriceFromString(items.getOffer_price())));
            }
        ...
        holder.deleteList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ListItems_RecyclerView_Adapter.this.notifyItemRemoved(position);
...
//        expandedImageView.setImageResource(imageResId);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView description, name, brand, price, offerPrice, validTill, offer, quantity, total;
